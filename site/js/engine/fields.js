...
(
	CFieldChunk,
	{
	    ...
	    _paint: function() {
	        var sContent = "";
	        sContent +=
                '<input id="' + this._sInstance + '_place" class="disp_chunk w_100" value="' + this.getValue() + '" />';
	        insertContent(this._sPlace, sContent);
	        this._validate();
	    }
	}
	...
	CControl,
	{
	    ...
	    _paint: function() {
	        ...
	        if (this._aBlockCfgs.length) {
	            sContent += this._sHeader.toFormat("color: #FFFFFF; font-size: 22px; font-weight: normal;") + "<br />";
	            sContent +=

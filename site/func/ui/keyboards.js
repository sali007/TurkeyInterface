	...
	componentBase,
	{
	    constructor: function(parent, instance, place, type, picFolder) {
	        ...
	        if (this.type.substring(0, 2) == 'DG') {
				...
				'<td id="btn_1" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'@~¸¨\')></td>' +
				...
				'<td id="btn_15" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'qQéÉ\')></td>' +
				'<td id="btn_16" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'wWöÖ\')></td>' +
				'<td id="btn_17" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'eEóÓ\')></td>' +
				'<td id="btn_18" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'rRêÊ\')></td>' +
				'<td id="btn_19" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'tTåÅ\')></td>' +
				'<td id="btn_20" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'yYíÍ\')></td>' +
				'<td id="btn_21" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'uUãÃ\')></td>' +
				'<td id="btn_22" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'iIøØ\')></td>' +
				'<td id="btn_23" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'oOùÙ\')></td>' +
				'<td id="btn_24" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'pPçÇ\')></td>' +
				'<td id="btn_25" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'[{õÕ\')></td>' +
				'<td id="btn_26" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\']}úÚ\')></td>' +
				...
				'<td id="btn_27" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'aAôÔ\')></td>' +
				'<td id="btn_28" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'sSûÛ\')></td>' +
				'<td id="btn_29" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'dDâÂ\')></td>' +
				'<td id="btn_30" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'fFàÀ\')></td>' +
				'<td id="btn_31" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'gGïÏ\')></td>' +
				'<td id="btn_32" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'hHðÐ\')></td>' +
				'<td id="btn_33" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'jJîÎ\')></td>' +
				'<td id="btn_34" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'kKëË\')></td>' +
				'<td id="btn_35" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'lLäÄ\')></td>' +
				'<td id="btn_36" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\';:æÆ\')></td>' +
				'<td id="btn_37" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'**ýÝ\')></td>' +
				...
				'<td id="btn_38" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'zZÿß\')></td>' +
				'<td id="btn_39" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'xX÷×\')></td>' +
				'<td id="btn_40" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'cCñÑ\')></td>' +
				'<td id="btn_41" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'vVìÌ\')></td>' +
				'<td id="btn_42" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'bBèÈ\')></td>' +
				'<td id="btn_43" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'nNòÒ\')></td>' +
				'<td id="btn_44" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick=' + ins + '.akeyPress(\'mMüÜ\')></td>' +
				'<td id="btn_45" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick="' + ins + '.akeyPress(\',<áÁ\')"></td>' +
				'<td id="btn_46" align="center" valign="middle" style="width: 64px; height: 64px; font-size: 30px; font-weigth: bold; background: url(\'' + this.picFolder + '/kboard/button.gif\');" onClick="' + ins + '.akeyPress(\'.>þÞ\')"></td>' +
